---
title: "Dysel Features"
parent: "Features"
---

# Dysel Features

The table below lists the Dysel-specific features that can be managed from the feature management page in Dysel BC.

| Feature | Details | Automatically enabled from | Learn more |
| --- | --- | --- | --- |
| New Extended Text | The new extended text is designed to be more stable and is better equipped for integration with APIs. | May 2026 (28.0.202605) | [Learn more](/Features/Dysel%20Features/NewExtendedText.html) |
