...
| 67365 | Equipment | Improved Service Action Entry processing so duplicate entries no longer distort calculations, and overall service action handling is more reliable. For more details, see [learn.dysel.com](https://learn.dysel.com). |
...
| 68419 | Equipment | Additional Service Action Entry improvements delivered under the same refactoring stream as case 67365. For more details, see [learn.dysel.com](https://learn.dysel.com). |
