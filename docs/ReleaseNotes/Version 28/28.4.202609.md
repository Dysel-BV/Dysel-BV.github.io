...
| 67862 | Equipment | Fixed a bug that prevented Branch, ELC Doc. Type and ELC Document No. to display for posted sales documents on the **Documents** action when called from the equipment object list or card. |
