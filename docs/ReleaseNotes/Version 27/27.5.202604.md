...
| 67365 | Equipment | Improved Service Action Entry processing so duplicate entries no longer distort calculations, and overall service action handling is more reliable. For more details, see [Service Action Overview on Dysel Learn](https://learn.dysel.com/DyselBC/Service/ServicePlanning/ServiceActionOverview.html). |
...
| 68419 | Equipment | Additional Service Action Entry improvements delivered under the same refactoring stream as case 67365. For more details, see [Service Action Overview on Dysel Learn](https://learn.dysel.com/DyselBC/Service/ServicePlanning/ServiceActionOverview.html). |
...
-  [New Extended Text](https://learn.dysel.com/Features/Dysel%20Features/NewExtendedText.html)
-  [Rental Credit](https://learn.dysel.com/Features/Dysel%20Features/RentalCredit.html)
-  [SADB Work Order Creation Wizard](https://learn.dysel.com/Features/Dysel%20Features/ServiceActionDispatchBoardWorkOrderCreation.html)