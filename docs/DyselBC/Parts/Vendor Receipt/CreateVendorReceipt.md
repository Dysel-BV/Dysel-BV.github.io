...
This guide walks you through creating a Vendor Receipt and adding the lines you are
receiving against one or more Purchase Orders.

* * *

## **Step 1:** Open the Vendor Receipts list

Navigate to the **Vendor Receipts** page. You can do this by selecting it from the
menu or by searching for "Vendor Receipts".

* * *

## **Step 2:** Start a new Vendor Receipt

1. On the **Vendor Receipts** page, click **New**.
...
2. **Location Code** — the location (warehouse) where the goods are being received.
...
5. **Branch** and **Department** — fill in if your organisation uses them.
...
## **Step 4:** Add lines — choose how

There are two ways to add the lines you are receiving. Use whichever fits the
delivery.

### Option A — Receive from a single Purchase Order (anchor PO)
...
1. **Qty. on Packing Slip** — the quantity the supplier states they sent.
2. **Qty. Actually Received** — the quantity you physically counted.

If **Qty. Actually Received** is **less than** **Qty. on Packing Slip**, the shortfall
is treated as **Qty. to Claim** — a shortage or damage that will raise a claim when
you post. See [Release and Post a Vendor Receipt](ReleaseAndPostVendorReceipt.md).

* * *

## **Step 6:** Item tracking and equipment objects

- **Item tracking** — for items that use serial or lot numbers, open the
  **Item Tracking Lines** action on a line and enter the tracking details.
- **Equipment objects** — lines that receive an equipment object **must** have a
  **Serial No.** before the receipt can be posted. The system checks this during the
  pre-posting checks.
...
Check the lines and quantities for accuracy. When the receipt reflects what actually
