...
Instructions allow you to attach a free-text note to a record — such as a customer, ship-to address, a piece of equipment, or a sales order. When you open a document that is related to that record, the note appears automatically in the **Instructions** panel. This way, anyone working on the document can see important information without having to go looking for it.
...
1. Open the record you want to add an instruction to (for example, a Customer card).
2. Select **Instructions** from the action bar.
3. Type your note in the text field.
4. Close the panel. Your note is saved automatically.

The next time someone opens a document related to this record, the instruction will appear in the Instructions panel.
